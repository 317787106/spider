...
class AmazonSpider(CrawlSpider):
    ...
    def start_requests(self):
        #上半部分
        city_border_points = open('city_map/all_map_202.txt').readlines()
        ...
        #下半部分
        city_border_points2 = open('city_map/all_map_201.txt').readlines()
    ...
    def parse_routine(self, response):
        ...
        fp = open('city_map/all_map_2_part2.txt','a')
        index = 0
